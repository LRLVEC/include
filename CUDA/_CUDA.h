...
namespace CUDA
{
	...
	struct NBodyCUDAVR : ::OpenGL::OpenGL
	{
		struct Particles
		{
			struct Particle
		...
		struct Renderer : ::OpenGL::Program
		{
			...
			::OpenGL::VertexAttrib positions;
			::OpenGL::VertexAttrib velocities;
			::OpenGL::VR::VRDevice* hmd;
			::OpenGL::VR::Trans* vrTrans;
			::OpenGL::VR::FrameBufferDesc leftEyeDesc;
			::OpenGL::VR::FrameBufferDesc rightEyeDesc;
			::OpenGL::FrameScale windowSize;

			Renderer(::OpenGL::SourceManager* _sm, ::OpenGL::Buffer* _particlesBuffer, ::OpenGL::Transform* _trans, ::OpenGL::VR::Trans* _vrTrans, ::OpenGL::VR::VRDevice* _hmd)
				:
				Program(_sm, "Renderer", Vector< ::OpenGL::VertexAttrib*>{&positions, & velocities}),
				trans(_trans),
				transBuffer(&_trans->bufferData),
